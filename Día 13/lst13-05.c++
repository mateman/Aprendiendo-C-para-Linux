...
class Animal // base común para caballo y ave
{
public:
          Animal(int);
...
public:
          ...
          virtual void Relinchar()const { cout << "JYihiil...";}
...
public:
          ...
          virtual void Volar()const { cout << "¡Puedo volar! ¡Puedo volar! iPuedo volar! "; }
          virtual COLOR ObtenerColor()const { return suColor; }
...
public:
          ...
          virtual int ObtenerEdad() const { return Caballo::ObtenerEdad(); }
private:
          long suNumeroCreyentes;
};

Pegaso::Pegaso( COLOR aColor, CUARTAS altura, bool emigra, long NumCreyen, int edad):
  Caballo(aColor, altura,edad), Ave(aColor, emigra,edad), suNumeroCreyentes(NumCreyen)
{
        cout << "Constructor dePegaso...\n" ;
}
